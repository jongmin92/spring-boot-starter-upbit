...
interface UpbitWithdrawsAsyncService {
     ...
     * @return 개별 출금 정보
     */
    fun getWithdraw(uuid: String, txid: String? = null, currency: String? = null): CompletableFuture<UpbitWithdraw>
     ...
     */
    fun getWithdrawsChance(currency: String): CompletableFuture<UpbitWithdrawsChance>
     ...
     * @return 원화 출금 결과
     */
    fun postWithdrawKrw(amount: String): CompletableFuture<UpbitWithdrawKrwPost>
}
