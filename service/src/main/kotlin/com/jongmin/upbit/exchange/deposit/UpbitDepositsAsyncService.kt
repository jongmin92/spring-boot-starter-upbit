...
interface UpbitDepositsAsyncService {
     ...
     * @return 개별 입금 정보
     */
    fun getDeposit(uuid: String, txid: String? = null, currency: String? = null): CompletableFuture<UpbitDeposit>
     ...
     */
    fun createDepositCoinAddress(currency: String): CompletableFuture<UpbitCreateDepositCoinAddress>
     ...
     */
    fun getDepositsCoinAddresses(): CompletableFuture<List<UpbitDepositCoinAddress>>
     ...
     * @return 보유한 입금 주소
     */
    fun getDepositsCoinAddress(currency: String): CompletableFuture<UpbitDepositCoinAddress>
     ...
     * @return 입금 결과
     */
    fun postDepositKrw(amount: String): CompletableFuture<UpbitDepositKrw>
}
